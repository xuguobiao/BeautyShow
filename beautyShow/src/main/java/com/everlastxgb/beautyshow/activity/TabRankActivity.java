 ...
 */
public class TabRankActivity extends BaseTabActivity {
    ...
    private String defaultUrl = URLs.RANK;
    ...
    public static TabRankActivity Self;
    ...
    private void startListThread(final boolean isLoadingNew) {
        ...
        ApiController.getRankListModel(URLs.getValidUrl(url), sort, new MyResultCallback(self(), isLoadingNew));
    }
    ...
    public class MyResultCallback extends ResultCallback {
        ...
        @Override
        public void onResult(Object result, boolean success, String errMsg) {
            pullToRefreshView.onRefreshComplete();
            mIsLoading = false;
            if (success) {
                GirlListModel listModel = (GirlListModel) result;
